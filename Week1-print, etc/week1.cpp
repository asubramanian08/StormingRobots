...
void q4(void)
{
	...
	printf("Balence remaining after first payment: %.2f \n Balence remaining after second payment: %.2f \n Balence remaining after third payment: %.2f \n", first, second, third);
